...
def eval(node, scope=(None, {}, {})):
    ...
    elif node[0] == "begin": any(eval(n, scope) and False for n in node[1])
    ...
    elif node[0] == "while": any(eval(node[2], scope) and False for _ in iter(lambda: bool(eval(node[1], scope)), False))
